...
const OdnoklassnikiIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm.055 4.878c1.927 0 3.487 1.562 3.487 3.489 0 1.927-1.56 3.487-3.487 3.487-1.927 0-3.489-1.56-3.489-3.487 0-1.927 1.562-3.489 3.489-3.489zm5.37 8.86c-.577.578-1.28.978-2.033 1.207l2.617 2.616c.457.457.457 1.196 0 1.652-.457.457-1.196.457-1.652 0L14 16.877l-2.358 2.336c-.228.229-.526.343-.826.343-.299 0-.597-.114-.826-.343-.457-.456-.457-1.195 0-1.652l2.617-2.616c-.752-.229-1.455-.629-2.033-1.207-1.43-1.43-1.43-3.76 0-5.19.711-.712 1.659-1.103 2.668-1.103 1.008 0 1.956.391 2.668 1.103 1.43 1.43 1.43 3.76 0 5.19z"/>
  </svg>
);
...
const socialLinks = [
  { href: "https://t.me/sined_fuel", title: "Telegram", Icon: TelegramIcon },
  { href: "https://wa.me/78121234567", title: "WhatsApp", Icon: WhatsAppIcon },
  { href: "https://ok.ru/sined", title: "Одноклассники", Icon: OdnoklassnikiIcon },
  { href: "https://vk.com/sined_fuel", title: "ВКонтакте", Icon: VKIcon },
];
